...
const BUSES = [
  { id: 1, operator: 'Angel VIP Express',   code: 'VIP', color: '#1a56db', type: 'VIP AC',        dep: '06:00', arr: '10:00', duration: '4h 00m', amenities: ['AC', 'WiFi', 'USB Port', 'Recliner'], baseFare: 875, totalSeats: 36 },
  { id: 2, operator: 'Angel Executive',      code: 'EXE', color: '#059669', type: 'Executive AC',   dep: '07:30', arr: '12:00', duration: '4h 30m', amenities: ['AC', 'USB Port'],                    baseFare: 700, totalSeats: 40 },
  { id: 3, operator: 'Angel Business Coach', code: 'BUS', color: '#7c3aed', type: 'Business Class', dep: '09:00', arr: '14:00', duration: '5h 00m', amenities: ['AC', 'Recliner'],                    baseFare: 630, totalSeats: 44 },
  { id: 4, operator: 'Angel Express',        code: 'EXP', color: '#dc2626', type: 'Standard AC',    dep: '10:00', arr: '15:30', duration: '5h 30m', amenities: ['AC'],                                baseFare: 525, totalSeats: 50 },
  { id: 5, operator: 'Angel Night Rider',    code: 'NGT', color: '#0f172a', type: 'Overnight AC',   dep: '20:00', arr: '01:00', duration: '5h 00m', amenities: ['AC', 'Blanket', 'Snack'],            baseFare: 665, totalSeats: 40 },
  { id: 6, operator: 'Angel Economy Plus',   code: 'ECO', color: '#d97706', type: 'Economy',        dep: '12:00', arr: '18:00', duration: '6h 00m', amenities: ['Fan'],                               baseFare: 350, totalSeats: 54 },
];

// Multipliers relative to Freetown→Bo baseline (= 1.0)
const ROUTE_MULTIPLIERS = {
  'Freetown-Bo': 1.0,             'Freetown-Kenema': 1.2857,        'Freetown-Makeni': 0.8571,
  'Freetown-Koidu (Kono)': 1.7143,  'Freetown-Kailahun': 1.90,        'Freetown-Port Loko': 0.55,
...
function calculateFare(bus, from, to) {
  ...
  return Math.round(bus.baseFare * mult);
}
